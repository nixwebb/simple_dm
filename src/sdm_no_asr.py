...
class HCIHY(smach.State):
    def __init__(self):
        smach.State.__init__(self, outcomes=['process'])
...
# Version of HCIHY that uses ASR
#        smach.StateMachine.add('HCIHY', HCIHY(), 
#                               transitions={'asr':'ASR'})

# Plus unused ASR node
...
# Version of HCIHY that DOESN'T use ASR
        smach.StateMachine.add('HCIHY', HCIHY(), 
                               transitions={'process':'PROCESS'})
